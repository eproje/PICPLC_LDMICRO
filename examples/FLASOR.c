...
STATIC BOOL U_b_R2 = 0;
#define Read_U_b_R2() U_b_R2
#define Write_U_b_R2(x) U_b_R2 = x
...
void PlcCycle(void)
{
    ...
    Write_U_b_R1(Read_I_b_rung_top());
    ...
    Write_U_b_R2(Read_I_b_parThis_0000());
    
    if(Read_I_b_parThis_0000()) {
        Write_I_b_parOut_0000(1);
    }
    Write_I_b_parThis_0000(Read_I_b_rung_top());
    Write_U_b_Y1(Read_I_b_parThis_0000());
